...
tfidf_by_gender = {}
tfidf_by_gender["old"] = np.asarray(vectorizer.transform(man_docs).mean(axis=0))[0]
tfidf_by_gender["young"] = np.asarray(vectorizer.transform(woman_docs).mean(axis=0))[0]
...
df.to_csv("fineweb-old_young-tfidf-output.csv")
